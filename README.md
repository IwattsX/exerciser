...
Exerciser is a mobile game that is meant to promote health and entertainment. The user is to walk around their areas to defeat enemies in the app and earn rewards, allowing for a friendly and heroic environment for those who wish to improve their physical health while enjoying their time doing so.
...
![MileStone Sprint 1](./MilestonesSprint1.png)
![Project board sprint1](./ProjectBoardSprint1.png)
